...
public  class Deck {
    ...
    private ChanceCard generateChanceCard(String[] splittedString) {
        ...
        switch (action) {
            ...
            case AdvanceToLocation:
                card = new ChanceCard(name, action, Board.getInstance().getSpaceOnBoard(splittedString[3]));
                break;
    ...
    private CommunityChestCard generateCommunityChestCard(String[] splittedString) {
        ...
        switch (action) {
            ...
            case AdvanceToLocation:
                card = new CommunityChestCard(name, action, Board.getInstance().getSpaceOnBoard(splittedString[3]));
                break;
            case CollectMoneyFromBank:
