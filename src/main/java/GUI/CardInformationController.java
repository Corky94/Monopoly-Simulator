...
public class CardInformationController {
    ...
    public void initialize() {
        ...
        ArrayList<Space> arrayListOfAllLocations = new ArrayList(Arrays.asList(Board.getInstance().getAllSpaces().toArray()));
        ...
        if (title.contains("Chance") || previousCard instanceof ChanceCard) {
            switch (action) {
                case AdvanceToLocation:
                    ...
                    Space space = Board.getInstance().getSpaceOnBoard(nameOfSpace);
